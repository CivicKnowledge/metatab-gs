...
// Iterate over the terms in the Meta sheet, setting a validation list for each term. 
...
function copyRemoteSheet(docId, sheetName) {
    ...
    if (remoteSheet) {
        ...
        Logger.log("copyRemoteSheet: remote " + docId + " to " + sheetName);

        moveSheetIfExists(sheetName);

        Logger.log("copyRemoteSheet: " + remoteSheet.getName());
        ...
        Logger.log("copyRemoteSheet: remote has no sheet " + sheetName);
    }
}
